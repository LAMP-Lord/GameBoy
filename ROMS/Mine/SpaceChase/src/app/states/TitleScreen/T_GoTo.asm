...
SECTION "Titlescreen - Keyboard WRAM", WRAM0

T_Index:: ds 1

T_PrintLocation:: ds 2
T_MaxCharacters:: ds 1
T_CurCharacters:: ds 1

T_PrintLocationTable:: ds 8
T_PrintLocationTableEnd::
T_CurCharactersTable:: ds 4
T_CurCharactersTableEnd::

SECTION "TitleScreen - New Game", ROMX, BANK[$1]
...
TitleScreen_GoTo_NewGame::
    ...
    ld bc, T_PrintLocationTableEnd - T_PrintLocationTable
    call Memory_Fill

    ld d, 0
    ld hl, T_CurCharactersTable
    ld bc, T_CurCharactersTableEnd - T_CurCharactersTable
    call Memory_Fill

    ld a, 4
    ld [T_CurCharactersTable], a
    ld a, $9E
    ld [T_PrintLocationTable], a
    ld a, $B9
    ld [T_PrintLocationTable+1], a
.skipResets
...
RandomizeSeed:
    ...
    ld a, 4
    ld [T_CurCharactersTable], a
    PUT_16_BITS $9E, $B9, T_PrintLocationTable
    call App_GenerateSeed
    PRINT_HEX [Save.Seed], $9EB6
    PRINT_HEX [Save.Seed+1], $9EB8
...
.Setup
    ...
    ld bc, 0
    ld hl, T_Text.nConfirm1
    ld de, $9AD4
    call Text_AniPrintText

    ld bc, 0
    ld hl, T_Text.nConfirm2
    ld de, $9AF4
    call Text_AniPrintText
...
SECTION "Titlescreen - Continue", ROMX, Bank[$1]
...
TitleScreen_GoTo_Continue::
    ...
    ld bc, T_Text.cTotalMoney
    ld hl, OAM_DMA + $28
    ld d, 28
    ld e, 68
    call Text_PrintTextAsObj

    ld bc, T_Text.cTotalKills
    ld hl, OAM_DMA + $50
    ld d, 28
    ld e, 92
    call Text_PrintTextAsObj

    ld bc, T_Text.ContinueQ
    ld hl, OAM_DMA + $78
    ld d, 28
    ld e, 116
    call Text_PrintTextAsObj
