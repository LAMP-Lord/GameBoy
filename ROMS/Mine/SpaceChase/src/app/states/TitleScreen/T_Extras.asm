...
.SelectKey
    ...
    ld a, [T_CurCharacters]
    cp 0
    jr z, .maxcharactersreached
    dec a
    ld [T_CurCharacters], a

    ld a, [T_PrintLocation]
    ld h, a
    ld a, [T_PrintLocation+1]
    ld l, a
    ...
    ld a, h
    ld [T_PrintLocation], a
    ld a, l
    ld [T_PrintLocation+1], a
...
.useDefault
    PUT_16_BITS d, e, T_PrintLocation

.endLoadState
    ld hl, T_CurCharactersTable
    ld a, [T_Index]
    add l
    ld l, a
    ld a, [hl]
...
TitleScreen_DrawPopup::
    ld de, T_Graphics.BoxTileMapLeft
    ld hl, $9E40
.leftrow
    ld a, [de]
    cp 255
...
.leftdone   
    ...
    ld de, T_Graphics.BoxTileMapRight
    ld hl, $9E51
.rightrow
    ld a, [de]
    cp 255
...
.resetship
    ...
    ld hl, OAM_DMA
    CREATE_OBJECT 1, 204, 72, %00000_100
    CREATE_OBJECT 2, 204, 80, %00000_100
    CREATE_OBJECT 3, 204, 88, %00000_100

    CREATE_OBJECT 4, 212, 72, %00000_100
    CREATE_OBJECT 5, 212, 80, %00000_100
    CREATE_OBJECT 6, 212, 88, %00000_100

    CREATE_OBJECT 7, 220, 72, %00000_100
    CREATE_OBJECT 8, 220, 80, %00000_100

    CREATE_OBJECT 9, 228, 64, %00000_100
    CREATE_OBJECT 10, 228, 72, %00000_100
    CREATE_OBJECT 11, 228, 80, %00000_100

    CREATE_OBJECT 12, 236, 64, %00000_100
    CREATE_OBJECT 13, 236, 72, %00000_101
    CREATE_OBJECT 14, 236, 80, %00000_101
    CREATE_OBJECT 15, 244, 72, %00000_100
    ret